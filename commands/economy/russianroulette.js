module.exports = {
    ...
    async execute(message, args, d) {
            ...
            message.channel.awaitMessages(filter, {
                ...
                .then(message => {
                    ...
                    if (message.content.toLowerCase() === 'yes' || message.content.toLowerCase() === 'y') {
                        ...
                        message.channel.send('You fucking idiot.')
                    }
                    else { message.channel.send('You fucking idiot. Yes or no.') }
                })
                .catch(collected => {
                    message.channel.send('You fucking idiot. Yes or no.')
                });
        }
        ...
        else { message.channel.send('You fucking idiot. Give a valid amount to bet.') }
    }
};
